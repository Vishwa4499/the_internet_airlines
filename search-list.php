<?php
	...
	$R = $_REQUEST;
	$SQL="SELECT * FROM `route`, `company`, `airlines`,`city` WHERE route_from_city = city_id AND route_airlines_id = airlines_id AND airlines_company_id = company_id AND route_from_city = $R[train_from] AND route_to_city = $R[train_to]";
...
.myrow {
	...
	<div id="content_sec">
		...
		<div class="contact">
			<h4 class="heading colr">All Available Airliness</h4>
			<?php
			if($_REQUEST['msg']) { 
			?>
				...
				<div class="static">
					<table style="width:100%">
					  <tr class="tablehead bold">
						<td style="width:16%">Airlines</td>
						<td style="width:16%">Airlines No</td>
